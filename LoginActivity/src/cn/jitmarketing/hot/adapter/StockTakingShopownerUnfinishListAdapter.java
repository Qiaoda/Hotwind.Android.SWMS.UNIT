...
public class StockTakingShopownerUnfinishListAdapter extends BaseAdapter {

	private List<StockTakingShopownerEntity> list;
	private LayoutInflater inflater;
	private Activity activity;

	public StockTakingShopownerUnfinishListAdapter(Activity activity,
			List<StockTakingShopownerEntity> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(
					R.layout.stock_taking_shopowner_unfinish_item, null);
